...
//        waitForStart();
        ...
        if (tagOfInterest == null || tagOfInterest.id == LEFT) {
            TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(new Pose2d(34.25, -62.375, Math.toRadians(90)))
                    //.forward(22)
                    .splineTo(new Vector2d(28,-31), Math.toRadians(120))
                    .waitSeconds(1.5)
                    .setReversed(true)
                    .splineTo(
                            new Vector2d(36, -11), Math.toRadians(180))
...
//                            SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                    ...
                    .lineToSplineHeading(new Pose2d(28,-14, Math.toRadians(220)))
                    .waitSeconds(1.5)
            ...
            TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(new Pose2d(34.25, -62.375, Math.toRadians(90)))
                    //.forward(22)
                    .splineTo(new Vector2d(30,-29), Math.toRadians(120))
                    .waitSeconds(1.5)
                    .setReversed(true)
                    .splineTo(
                            new Vector2d(36, -11), Math.toRadians(180),
            ...
            TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(new Pose2d(34.25, -62.375, Math.toRadians(90)))
                    ...
                    .lineToLinearHeading(new Pose2d(46
                            ,-6, Math.toRadians(270)))
