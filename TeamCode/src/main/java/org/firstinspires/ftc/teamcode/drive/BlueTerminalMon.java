...
@Disabled
public class BlueTerminalMon extends LinearOpMode {
    OpenCvCamera camera;
...
//        waitForStart();
        ...
        if (tagOfInterest == null || tagOfInterest.id == LEFT) {
            TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(new Pose2d(34.25, -62.375, Math.toRadians(90)))
                    ...
                    .lineToSplineHeading(new Pose2d(30, -29, Math.toRadians(120))) //spline to medium junction
                    .waitSeconds(2)
...
//                                .turn(Math.toRadians(-30))
                    .forward(26)
                    .lineToSplineHeading(new Pose2d(60.5, -10.75, Math.toRadians(0)))
                    .addTemporalMarker(7, () -> {
                        //lift to stack pos
                        drive.liftMotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                        drive.liftMotor.setPower(-1);
                    ...
                    .lineToSplineHeading(new Pose2d(45,-13.75, Math.toRadians(0)))
...
//                    .lineToSplineHeading(new Pose2d(30,-16.5, Math.toRadians(215)))
                    ...
                    /*
                    drive.trajectorySequenceBuilder(new Pose2d(35.25, -62.375, Math.toRadians(90)))
                    //.forward(22)
                    .splineTo(new Vector2d(28,-28), Math.toRadians(130))
                    .setReversed(true)
...
//                    .back(20)
                    //.back(4)
                    //.lineToSplineHeading(new Pose2d(12, -12, Math.toRadians(128)))
//                    .build();
