...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 10.5;//35;//10.5; // in
     ...
     * empirically tuned.
     */
    public static double kV = 0.0109;//1.0 / rpmToVelocity(MAX_RPM);//0.0099;
    public static double kA = 0.0045;
    public static double kStatic = 0;//0.0102;
     ...
     */
    public static double MAX_VEL = 75;//30;
    public static double MAX_ACCEL = 90;//30;
    public static double MAX_ANG_VEL = 3.14;//1;//Math.toRadians(180);
    public static double MAX_ANG_ACCEL = 3.14;//.5;//Math.toRadians(180);
