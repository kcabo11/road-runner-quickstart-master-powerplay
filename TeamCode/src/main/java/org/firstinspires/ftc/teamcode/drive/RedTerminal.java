...
//        waitForStart();
        ...
        if (tagOfInterest == null || tagOfInterest.id == LEFT) {
            TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(new Pose2d(-35, -62.375, Math.toRadians(90))) //34.25
                    //.forward(22)
                    .splineTo(new Vector2d(-28,-31), Math.toRadians(40), //-24-24
...
//                    //  .back(5)
                    .setReversed(true)
                    .splineTo(
                            new Vector2d(-34, -14), Math.toRadians(0),
                    ...
                    .lineToSplineHeading(new Pose2d(-28,-14, Math.toRadians(315))) //-32.25,-19
                    .waitSeconds(2)
                    ...
                    .lineToLinearHeading(new Pose2d(-50,-6, Math.toRadians(270)),
...
//
            ...
            TrajectorySequence trajSeq = drive.trajectorySequenceBuilder(new Pose2d(-34.25, -62.375, Math.toRadians(90)))
                    ...
                    .setReversed(true)
                    .splineTo(
                            new Vector2d(-36, -11), Math.toRadians(0),
                            SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL,DriveConstants.TRACK_WIDTH),
                            SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                    .forward(26)
                    .waitSeconds(0.5)
                    ...
                    .lineToSplineHeading(new Pose2d(-28,-14, Math.toRadians(40)))
                    .waitSeconds(1.5)
                    ...
                    .lineToLinearHeading(new Pose2d(-46,-6, Math.toRadians(90)))
                    ...
                    .addTemporalMarker(14.20, () -> {
                        //lifting cone off stack
                        drive.liftMotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                        drive.liftMotor.setPower(-1);
                    })

                    .addTemporalMarker(15.00, () -> {
                        //hold lift position
                        drive.liftMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                        drive.liftMotor.setTargetPosition(drive.liftMotor.getCurrentPosition());
                        drive.liftMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
